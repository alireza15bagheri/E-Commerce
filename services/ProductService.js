const PRODUCTS = [
  ...
  },
  {
    ...
    description:
      "Processor: Intel Core i9 11900H RAM: 32 GB (16GBx2 TWIN BLADE) Storage: 1024GB PCIe NVMe SSD",
  },
];
// a function to access all products:
export function getProducts() {
  return PRODUCTS;
}
// a function to access a specific product data or details:
